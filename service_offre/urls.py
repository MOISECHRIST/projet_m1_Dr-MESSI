"""
URL configuration for service_offre project.
...
from offre.urls import router as offer_router
...
shema_view = get_schema_view(
    openapi.Info(
        ...
        description = "This API allow you to manage offers data (create offers, edit offers information, apply to an offer and valid offers applications)",
...
router.registry.extend(offer_router.registry)
urlpatterns = [
